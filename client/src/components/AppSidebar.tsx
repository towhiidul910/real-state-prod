...
const AppSidebar = ({ userType }: AppSidebarProps) => {
  ...
  return (
    <Sidebar
      collapsible="icon"
      className="fixed left-0 bg-white shadow-lg transition-all duration-300 ease-in-out"
      style={{
            ...
            return (
              <SidebarMenuItem key={link.href}>
                <SidebarMenuButton asChild className={cn(
                  "flex items-center py-7", isActive ? "bg-gray-100 " : "text-gray-600 hover:bg-gray-100", open ? "text-blue-600" : "ml-[5px]"
                )}>
