...
const Application = () => {
  ...
  return (
    <div className="dashboard-container">
      <Header
        title="Applications"
        subtitle="Track and manage your property rental application"
      />
        ...
        {applications?.map((application) => (
          ...
          >
            ...
            {application.status === "Approved" ? (
              ...
              <button
                className={`bg-white border border-gray-300 text-gray-700 py-2 px4 rounded-md flex items-center justify-center hover:bg-primary-700 hover:text-primary-50`}
              >
